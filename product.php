				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<p>Experience the purity of nature with our range of organic products, carefully sourced and crafted to support a healthy lifestyle. Grown/furnished  without the use of harmful chemicals, pesticides, or synthetic fertilizers, our organic offerings are rich in nutrients, environmentally friendly, and completely natural. Each product is tested for quality, ensuring that what you consume or use is safe, wholesome, and sustainably produced whether it is food,clothing accessories,furniture or skin care/personal care.</p>
							...
							<div class="product-options">
								...
								<label>
									...
									<option value="0">off white</option>
									</select>
								</label>
							</div>
							...
							<ul class="product-links">
								<li>Category:</li>
								<li><a href="#">Hair,Furniture,Clothing,Gardening,personal care,baby care. </a></li>

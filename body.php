				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>eco utnsils<br>Collection</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								<h3>natural persnal care<br>Collection</h3>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">organic food and beverages</a></li>
									<li><a data-toggle="tab" href="#tab1">natural personal care</a></li>
									<li><a data-toggle="tab" href="#tab1">sustainable fashion</a></li>
									<li><a data-toggle="tab" href="#tab1">eco-friendly packaging</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">organic</a></li>
									<li><a data-toggle="tab" href="#tab2">eco friendly </a></li>
									<li><a data-toggle="tab" href="#tab2">sustainable</a></li>
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="#">organic products</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">eco friendly products</a></h3>
										<h4 class="product-price"> 980.00 <del class="product-old-price">990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">serums</a></h3>
										<h4 class="product-price">rs 980.00 <del class="product-old-price">Rs990.00</del></h4>
									</div>
								</div> 
								<!-- product widget -->
							</div>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">natural extracts</a></h3>
										<h4 class="product-price">980.00 <del class="product-old-price">990.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
						...
						<div class="products-widget-slick" data-nav="#slick-nav-5">
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">organic poducts</a></h3>
										<h4 class="product-price">980.00 <del class="product-old-price">990.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
